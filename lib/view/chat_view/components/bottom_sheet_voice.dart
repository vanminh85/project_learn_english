...
class _BottomSheetVoiceState extends State<BottomSheetVoice> {
  ...
  bool get isTextEmtpy => _lastWords == '';

  void _initSpeech() async {
    _speechEnabled = await _speechToText.initialize(
        onStatus: (v) => debugPrint(v), onError: (v) => debugPrint(v.errorMsg));
  ...
  Widget _buttonBase(
      ...
      bool isCheckTextEmpty = true,
      required Color colour}) {
    return MaterialButton(
      color: colour,
      elevation: 3,
      onPressed: isCheckTextEmpty
          ? isTextEmtpy || _speechToText.isListening
              ? null
              : onPressed
          : onPressed,
